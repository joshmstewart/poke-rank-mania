    ...
    <div className="relative inline-flex items-center">
      ...
      <div className="mr-2">
        <span className="font-bold text-3xl md:text-4xl tracking-wider" style={{
          ...
          textShadow: "0 1px 2px rgba(0, 0, 0, 0.6), 2px 1px 0 #3761a8, -1px -1px 0 #3761a8, 1px -1px 0 #3761a8, -1px 1px 0 #3761a8", // Thicker blue outline (#3761a8)
      ...
      <div className="relative">
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 bottom-0 translate-y-1/3 w-6 h-6 bg-white rounded-full border-2 border-[#8E9196] flex items-center justify-center">
