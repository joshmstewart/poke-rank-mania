    ...
    <div className="relative inline-flex items-center">
      ...
      <div className="mr-2">
        <span className="font-bold text-3xl md:text-4xl tracking-wider" style={{
          ...
          textShadow: "0 2px 4px rgba(0, 0, 0, 0.5), 2px 2px 0 #3761a8, -2px -2px 0 #3761a8, 2px -2px 0 #3761a8, -2px 2px 0 #3761a8", // Reduced blue outline (#3761a8)
      ...
      <div className="relative">
        ...
        {/* Pokeball-inspired circle with specified colors */}
